...
export const buildBookingFormSchema = (requireAccountFields: boolean) =>
  z
    .object({
...
export type BookingFormValues = z.infer<ReturnType<typeof buildBookingFormSchema>>;
